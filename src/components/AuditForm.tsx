...
const AuditForm = () => {
  ...
  const inputClass =
    'w-full bg-[#0e0e0e] border border-[#252525] text-[#e0e0e0] placeholder-[#444] px-4 py-4 text-base focus:border-[#555] focus:outline-none transition-colors';

  return (
    <section id="audit-form" className="bg-[#0d0d0d] border-t border-[#1a1a1a] px-8 lg:px-14 py-24">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-28">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <button
            ...
            className="mt-2 w-full bg-[#e8e8e8] text-[#0e0e0e] text-base font-medium py-4 hover:bg-white transition-colors disabled:opacity-40"
          >
